---
title: "FormDialog"
description: "* FormDialog - A consistent, production-ready dialog for forms * Features: - Accessible (keyboard nav, focus trap, screen reader support) - Animated open/close transitions - Consistent header, body, footer layout - Loading state support - Multiple sizes * Usage: ```tsx <FormDialog open={isOpen} onOpenChange={setIsOpen} title="Add New Item" description="Fill out the form below" onSubmit={handleSubmit} submitLabel="Create" > <FormField label="Name"> <Input value={name} onChange={(e) => setName(e.target.value)} /> </FormField> </FormDialog> ```"
---

* FormDialog - A consistent, production-ready dialog for forms * Features: - Accessible (keyboard nav, focus trap, screen reader support) - Animated open/close transitions - Consistent header, body, footer layout - Loading state support - Multiple sizes * Usage: ```tsx <FormDialog open={isOpen} onOpenChange={setIsOpen} title="Add New Item" description="Fill out the form below" onSubmit={handleSubmit} submitLabel="Create" > <FormField label="Name"> <Input value={name} onChange={(e) => setName(e.target.value)} /> </FormField> </FormDialog> ```
