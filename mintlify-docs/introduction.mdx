---
title: "Introduction"
description: "Welcome to the VoiceAgent Platform documentation"
---

# VoiceAgent Platform

VoiceAgent is an AI-powered voice call handling platform designed for UK HVAC and plumbing service businesses. It provides intelligent call routing, customer management, and automated booking capabilities.
...
├─────────────────────────────────────────────────────────────┤
│                    BACKEND SERVICES                          │
│  Next.js API Routes → Supabase (Database + Storage)         │
│                    → Email Notifications                     │
